...
const SvgLettersFire = () => {
  return (
    <div>
        <Flex justifyContent= 'center' height='500px' position='static'>
        <video className={styles.video} autoPlay playsInline muted loop preload='true'><source src='/Fire.mp4' type='video/mp4'/></video>
            <svg className={styles.svg} height='50%' width='100%' fontFamily='Montserrat' fontSize='35em' fontWeight='bold' text-transform='uppercase'>
                <defs>
